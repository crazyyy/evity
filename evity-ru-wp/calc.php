...
<?php if (have_posts()) :  while (have_posts()) : the_post(); ?>
	<!-- single -->
	<div class="single calc_page">
		<h1 class="title"><?php the_title(); ?></h1>
		<div class="calc-text">
			<p>
				Удобная форма заказа поможет вам подобрать весь необходимый функционал будущего сайта. Для
				начала выберите тип сайта (визитка, корпоративный, магазин), определите какие модули вам могут 
