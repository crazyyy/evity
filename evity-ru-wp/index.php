...
<div class="about-and-useful ">
	...
	<div class="wrapper-useful right">
		<h2 class="useful-main-title title wrap"><span class="left">Полезно знать</span> <a href="#" class="all robc right">читать все <span>статьи</span></a></h2>
		<div class="useful">
			<?php if(have_posts()):
...
<div class="wrapper-cat-news">
	<h2 class="title wrap"><span>Новости</span><a href="#" class="all robc right">читать все <span>новости</span></a></h2>
	<!-- cat-news -->
