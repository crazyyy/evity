...
?></title>
    ...
    <link href="<?php bloginfo('template_directory'); ?>/lend/css/style-lend-corp.css" rel="stylesheet">
    <!--[if lt IE 9]>
            ...
            <div class="center">
            	<div class="head_block">
                    ...
                    <div class="head_info">
                       ...
                       <p><? echo $caption; ?></p>
                        <br /><br />
                        <p><strong>Стоимость корпоративного сайта <strike>50 000 рублей</strike> 24990 рублей!</strong></p>
                        ...
                        <div class="sites_box" style="height: 100%">
                            ...
                            <div class="box_entry">
                                ...
                                <ul class="icon-list">
                                    ...
                                    <li>Каталоги товаров и услуг!</li>
                                    <li>Галереи фото и видео!</li>
                                    <li>Формы обратной связи!</li>
                                    <li>Формы заказа звонка!</li>
                                    <li>Юзабилити-тестирование!</li>
                                    <li>Регистрация в поисковиках!</li>
                        ...
                        <div class="sites_box">
                            ...
                            <div class="box_entry">
                                ...
                                <ul class="icon-list">
                                    ...
                                    <li>Установка аналитики посещаемости!</li>
                        ...
                        <div class="sites_box">
                            ...
                            <div class="box_entry">
                                ...
                                <ul class="icon-list">
                                    ...
                                    <li>Тексты под ключ!</li>
                                    <li>Callback-сервисы!</li>
                                    <li>Веб-аналитика - 3 месяца!</li>
 ...
 <div class="action_verh_zerk"></div>
        <section id="action_section" class="section right-direction">
			...
			<!-- <p>Мы хотим, чтобы ваш сайт начал приносить прибыль как можно скорее!</p> -->
                        <p>Закажите корпоративный сайт и получите <b>50%</b> скидки на создание рекламной компании в любой контекстной сети!</p>
        ...
        <section id="order_section" class="section">
        	<div class="center">
                ...
                <div class="order_text">
                	<p>Оставьте заявку сейчас и получите бесплатную прототипирование вашего будущего сайта!</p>
                </div>
